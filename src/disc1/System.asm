...
Text($000D996C, "Load FILE 1?"); fill 21
Text($000D9998, "Load FILE 2?"); fill 21

Text($000D99C4, "Load FILE 3?"); fill 21
Text($000D99F0, "Start the game from the beginning?") ; fill 5
Text($000D9A18, "Overwrite FILE 1?") ; fill 33
Text($000D9A4C, "Overwrite FILE 2?") ; fill 33
Text($000D9A80, "Overwrite FILE 3?") ; fill 33
Text($000D9AB4, "No Memory Card found in Slot A.") ; fill 17, $20
Text($000D9B1C, "There is no free space or the number of files[n]have been exeeeded. To save, you will need[n]one file and 4 blocks of free space.") ; fill 24, $20
Text($000D9BDC, "There is no free space or the number of files[n]have been exeeeded. To save, you will need[n]one file and 4 blocks of free space.") ; fill 24, $20
Text($000D9C9C, "The Memory Card in Slot A[n]has corrupted data and needs to be formatted.[n][n]") ; fill 2, $20
Text($000D9D24, "The Memory Card in Slot A[n]cannot be used for this game.[n][n]") ; fill 3, $20

Text($000D9DA0, "The Memory Card in Slot A[n]cannot be used.[n][n]") ; fill 16, $20
Text($000D9E18, "Formatting complete.[n][n][n]") ; fill 2, $20
Text($000D9E70, "[p1]Formatting may have failed because the Memory Card was removed during formatting.[p0]")
Text($000D9EFC, "The Memory Card may have been removed.") ; fill 25, $20
Text($000D9F74, "[n]        [x32][y32]Formatting...[x24][y24]")
Text($000D9FA8, "The game data saved on the Memory Card[n]in Slot A is corrupted.[n][n]") ; fill 24, $20
Text($000DA03C, "Save data has been deleted.[n][n][n]") ; fill $20
Text($000DA094, "Select the file to save.[n][n][n]") ; fill 14, $20
Text($000DA0FC, "Select the file to load.[n][n][n]") ; fill 14, $20
Text($000DA164, "Do not touch the Memory Card, Reset Button,[n]or Power Button while saving or data may be lost.[n][n]") ; fill 35, $20

Text($000DA22C, "[n]        [x32][y32]Saving...[x24][y24]")
Text($000DA260, "Saving complete.[n][n][n]") ; fill 6, $20
Text($000DA2B8, "[p1]The Memory Card was removed during writing,[n]so writing may have failed.[n][n]") ; fill 8, $20
Text($000DA34C, "There is no data for this game[n]on the Memory Card in Slot A.[n][n]") ; fill 5, $20
Text($000DA3CC, "To organize the contents of the Memory Card,[n]use the Memory Card management screen on the console.[n][n]") ; fill $20
Text($000DA45C, "There is something other than a[n]Memory Card inserted in Slot A.[n][n]")
Text($000DA4D4, "The Memory Card in Slot A[n]is broken and cannnot be used.[n][n]") ; fill 15, $20
Text($000DA55C, "[p1]Failed to write data.[p0][n]The Memory Card in Slot A[n]is broken and cannot be used.[n]") ; fill 27, $20
